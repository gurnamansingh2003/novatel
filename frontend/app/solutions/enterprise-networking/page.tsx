...
import "./page.css";
import QuickEnquiryModal from "@/app/components/QuickEnquiryModal/QuickEnquiryModal"; // Ensure this path is correct
...
export default function EnterpriseNetworkingPage() {
  ...
  return (
    <div className="enterprise-networking-page">
      ...
      <div className="hero-section">
        <div className="hero-overlay">
          <div className="hero-content">
            <h1 className="hero-title">Enterprise Networking Solutions</h1>
            <p className="hero-subtitle">
              Building the Backbone of Your Business with Advanced Network
              Infrastructure
            </p>
          </div>
        </div>
          ...
          <div className="content-grid">
            ...
            <div className="text-container">
              ...
              <p className="section-description">
                In today's digital-first world, a robust and reliable network
                infrastructure is the foundation of every successful business.
                Our Enterprise Networking solutions provide organizations with
                high-performance, secure, and scalable network systems that
                drive productivity and innovation.
              </p>
              <p className="section-description">
                From network design and implementation to ongoing management and
                support, we deliver comprehensive networking solutions that keep
                your business connected, secure, and operating at peak efficiency.
              </p>
          ...
          <div className="features-section">
            ...
            <div className="features-grid">
              <div className="feature-card">
                ...
                <p>
                  Custom-designed network infrastructure tailored to your
          ...
          <div className="benefits-section">
            ...
            <div className="benefits-grid">
              ...
              <div className="benefit-item">
                ...
                <p>
                  Our certified network engineers provide round-the-clock
                  support and proactive maintenance for peace of mind.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* Quick Enquiry Modal */}
      {isModalOpen && <QuickEnquiryModal onClose={closeModal} />}
    </div>
  );
}